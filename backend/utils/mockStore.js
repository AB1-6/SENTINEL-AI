...
export const mockStore = {
  ...
  documents: [
    ...
    },
    {
      _id: 'doc-5',
      userId: 'user-admin',
      originalName: 'Company_Identity_Products_and_Clients.pdf',
      filename: 'company_identity_and_clients.pdf',
      mimeType: 'application/pdf',
      size: 1850400,
      path: '/uploads/company_identity_and_clients.pdf',
    ...
    },
    {
      _id: 'doc-6',
      userId: 'user-admin',
      originalName: 'Sentinel_AI_2.0_Machine_Learning_and_Security_Blueprint.pdf',
      filename: 'sentinel_ml_security_blueprint.pdf',
      mimeType: 'application/pdf',
      size: 2450000,
      path: '/uploads/sentinel_ml_security_blueprint.pdf',
    ...
    },
    {
      _id: 'doc-7',
      userId: 'user-admin',
      originalName: 'Sentinel_AI_Architecture_and_System_Design.pdf',
      filename: 'sentinel_architecture_and_system_design.pdf',
      mimeType: 'application/pdf',
      size: 1200000,
      path: '/uploads/sentinel_architecture_and_system_design.pdf',
