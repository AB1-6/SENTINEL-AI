/**
 * Sentinel AI 2.0 - Canonical Financial Dataset & Calculation Service
...
export function getFollowUpPriority() {
  ...
  // Sree Fabrics has the largest delinquent exposure (₹1,20,000) & Top Client
  // Kavya Boutique has the longest aging (38 days)
